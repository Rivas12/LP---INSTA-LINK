    ...
    <section className="py-16 sm:py-32 relative overflow-hidden bg-white">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <div className="bg-white border border-orange-100 rounded-2xl sm:rounded-3xl p-6 sm:p-12 md:p-16 text-center shadow-xl">
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-extrabold text-gray-900 mb-4 sm:mb-6 leading-tight">
            ...
            <p className="text-base sm:text-xl md:text-2xl text-gray-600 mb-8 sm:mb-12 max-w-3xl mx-auto">
      ...
      {/* Footer */}
      <div className="relative mt-14 sm:mt-24 border-t border-gray-200 pt-8 sm:pt-12">

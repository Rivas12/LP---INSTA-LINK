      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-white border border-gray-200 rounded-2xl p-6 hover:border-primary-300 hover:shadow-lg transition-all group"
            >
              <feature.icon className="text-3xl text-primary-600 mb-3 group-hover:scale-110 transition-transform" />
        ...
        <div className="max-w-3xl mx-auto scroll-reveal-scale">
          <div className="bg-orange-50 border border-orange-200 rounded-2xl p-8 shadow-md">
